    ...
    <div class="p-4 mt-10 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="grid grid-cols-1 gap-4 mb-4">
                            ...
                            <div class="bg-white shadow-md rounded my-3">
                                <table class="min-w-max w-full table-auto ">
                                    ...
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($barang as $brg => $item)
                                        <tbody class="text-gray-600 text-sm font-light">
                                            <tr
                                                class="border-b border-gray-200 hover:bg-gray-100 {{ $brg % 2 === 0 ? 'bg-white' : ' bg-gray-100' }}">
                                                <td class="py-3 px-6 text-left">
                                                    <h5 class="ml-3">{{ $brg + $barang->firstItem() }}</h5>
                                                ...
                                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="mr-2">
                                                            ...
                                                            <span class="font-medium">Coffe {{ $item->nama_barang }}</span>
                                                        </div>
                                                </td>
                                                <td class="py-3 px-6 text-left">
                                                    <div class="flex items-center">
                                                ...
                                                <td class="py-3 px-6 text-center">
                                                    <div class="flex items-center justify-center">
                                                        <span
                                                            class="font-semibold text-slate-500">Rp{{ number_format($item->harga) }}</span>
                                                    </div>
                                                </td>
                                                <td
                                                    class="py-3
                                                            px-6 text-center">
                                                    <span
                                                        class=" text-purple-600 py-1 px-3 rounded-full text-xs">{{ $item->keterangan }}</span>
                                                </td>
                                                <td class="py-3 px-6 text-center">
                                                    <div class="flex item-center justify-center">

                                                        <a href="#" data-modal-target="edit-modal.{{ $item->id }}"
                ...
                {{ $barang->links('components.custom-pagination') }}
